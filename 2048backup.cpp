...
void Game_AI::game_end_check(Game *screen)
{
  ...
  if(response==-1)
  {
    cout<<"\n\n\t\t            > Thank you for playing. "
        <<"\n\n\n\t\t   Developed by Sivavisva and Perinbanathan \n\n";
    press_enter=getchar();
    exit(0);
  }
}
...
void Game::display_grid()
{
	system("cls");
		...
		cout<<"\n  ::[  THE 2048 PUZZLE  ]::\t\tDeveloped by Sivavisva and Perinbanathan\n\n\t";
...
void Game::display_help_screen()
{
	...
	cout<<endl<<"  ::[  THE 2048 PUZZLE  ]::\t\tDeveloped by Sivavisva and Perinbanathan ";
